...
static const u8 hidInformation[] =
    {
        U16_LO(0x0111),
        U16_HI(0x0111), // bcdHID (USB HID version)
        0x00,           // bCountryCode
        0x01            // Flags
};
...
static const u8                          my_OtaName[]          = {'O', 'T', 'A'};
    ...
    static u8  my_MicName[] = {'M', 'i', 'c'};
    static u8  my_SpeakerName[] = {'S', 'p', 'e', 'a', 'k', 'e', 'r'};
...
static const u8 my_PnCharVal[5] = {
    CHAR_PROP_READ,
    U16_LO(DeviceInformation_pnpID_DP_H),
    U16_HI(DeviceInformation_pnpID_DP_H),
    U16_LO(CHARACTERISTIC_UUID_PNP_ID),
...
static const u8 my_hidBootKeyInReportCharVal[5] = {
    ...
    U16_LO(HID_BOOT_KB_REPORT_INPUT_DP_H),
...
static const u8 my_hidReportCCinCharVal[5] = {
    CHAR_PROP_READ | CHAR_PROP_NOTIFY,
    U16_LO(HID_CONSUME_REPORT_INPUT_DP_H),
...
static const u8 my_hidReportKEYinCharVal[5] = {
    CHAR_PROP_READ | CHAR_PROP_NOTIFY,
    U16_LO(HID_NORMAL_KB_REPORT_INPUT_DP_H),
...
static const u8 my_hidReportMapCharVal[5] = {
    CHAR_PROP_READ,
    U16_LO(HID_REPORT_MAP_DP_H),
    U16_HI(HID_REPORT_MAP_DP_H),
...
static const u8 my_hidInformationCharVal[5] = {
    CHAR_PROP_READ,
    U16_LO(HID_INFORMATION_DP_H),
    U16_HI(HID_INFORMATION_DP_H),
...
static const u8 my_batCharVal[5] = {
    CHAR_PROP_READ | CHAR_PROP_NOTIFY,
    U16_LO(BATT_LEVEL_INPUT_DP_H),
    U16_HI(BATT_LEVEL_INPUT_DP_H),
    U16_LO(CHARACTERISTIC_UUID_BATTERY_LEVEL),
...
static const u8 TelinkSppDataClient2ServerCharVal[19] = {
    CHAR_PROP_READ | CHAR_PROP_WRITE_WITHOUT_RSP,
    U16_LO(SPP_CLIENT_TO_SERVER_DP_H),
    U16_HI(SPP_CLIENT_TO_SERVER_DP_H),
...
#endif
int normal_client2service(u16 connHandle, void *p)
{
    (void)connHandle;
    (void)p;
#if(TL_AUDIO_MODE & TL_AUDIO_MASK_HID_SERVICE_CHANNEL)
...
static const attribute_t my_Attributes[] = {
    ...
    {0,                                     ATT_PERMISSIONS_RDWR,  2,  sizeof(reportKeyOut),                      (u8 *)(size_t)(&hidReportUUID),                  (u8 *)(reportKeyOut),                              &normal_client2service,                       0   }, //value
    ...
    ********************************************************************************************/
    //0032
    {9,                                     ATT_PERMISSIONS_READ,  2,  16,                                        (u8 *)(size_t)(&my_primaryServiceUUID),          (u8 *)(size_t)(&sAudioGoogleServiceUUID),          0,                                            0   },

    //TX 0033-0034
    {0,                                     ATT_PERMISSIONS_RDWR,  2,  sizeof(sAudioGoogleTXChar),                (u8 *)(size_t)(&my_characterUUID),               (u8 *)(size_t)(sAudioGoogleTXChar),                0,                                            0   },
    {0,                                     ATT_PERMISSIONS_RDWR,  16, sizeof(sAudioGoogleTXData),                (u8 *)(size_t)(&sAudioGoogleTXUUID),             (u8*)(&sAudioGoogleTXData),                        &app_auido_google_callback,                   0   }, //value
    //RX 0035 - 0037
    {0,                                     ATT_PERMISSIONS_READ,  2,  sizeof(sAudioGoogleRXChar),                (u8 *)(size_t)(&my_characterUUID),               (u8 *)(size_t)(sAudioGoogleRXChar),                0,                                            0   },
    {0,                                     ATT_PERMISSIONS_READ,  16, sizeof(sAudioGoogleRXData),                (u8 *)(size_t)(&sAudioGoogleRXUUID),             (u8*)(&sAudioGoogleRXData),                        0,                                            0   },
    {0,                                     ATT_PERMISSIONS_RDWR,  2,  sizeof(gAudioGoogleRXCCC),                 (u8 *)(size_t)(&clientCharacterCfgUUID),         (u8*)(&gAudioGoogleRXCCC),                         0,                                            0   },
    //CTRL 0038 -003A
    {0,                                     ATT_PERMISSIONS_READ,  2,  sizeof(sAudioGoogleCTLChar),               (u8 *)(size_t)(&my_characterUUID),               (u8 *)(size_t)(sAudioGoogleCTLChar),               0,                                            0   },
    {0,                                     ATT_PERMISSIONS_READ,  16, sizeof(sAudioGoogleCTLData),               (u8 *)(size_t)(&sAudioGoogleCTLUUID),            (u8*)(&sAudioGoogleCTLData),                       0,                                            0   },
    {0,                                     ATT_PERMISSIONS_RDWR,  2,  sizeof(gAudioGoogleCTLCCC),                (u8 *)(size_t)(&clientCharacterCfgUUID),         (u8*)(&gAudioGoogleCTLCCC),                        0,                                            0   },
