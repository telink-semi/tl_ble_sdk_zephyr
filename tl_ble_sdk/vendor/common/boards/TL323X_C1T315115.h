 ...
 */
    ...
    #define GPIO_CHN1         GPIO_PC0
    #define GPIO_CHN2         GPIO_PA1
    #define GPIO_CHN3         GPIO_PC1
    #define GPIO_CHN4         GPIO_PA2
    #define GPIO_CHN5         GPIO_PC2
    #define GPIO_CHN6         GPIO_PA3
    #define GPIO_CHN7         GPIO_PC3

    #define GPIO_CHN8         GPIO_PA4
    #define GPIO_CHN9         GPIO_PC4
    #define GPIO_CHN10        GPIO_PC5
    #define GPIO_CHN11        GPIO_PC6
    #define GPIO_CHN12        GPIO_PC7
    #define GPIO_CHN13        GPIO_PE0
    #define GPIO_CHN14        GPIO_PE1
    #define GPIO_CHN15        GPIO_PE2
...
#define TLKAPI_DEBUG_GPIO_PIN GPIO_PD0
