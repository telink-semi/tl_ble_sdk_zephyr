...
/*cali table data format: 4byte header + 79*2 byte tone cali table + 79 byte packet 1M cali table + 79 byte packet 2M cali table*/
#define CALIB_OFFSET_CALI_TABLE_HEADER_INFO    0x300

#define CALIB_OFFSET_CALI_TABLE_TONE_INFO      0x304
