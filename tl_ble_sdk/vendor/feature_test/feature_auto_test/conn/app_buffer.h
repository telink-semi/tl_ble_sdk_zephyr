 ...
 */
        ...
        #define ACL_PERIPHR_TX_FIFO_NUM  17                                                 //user set value
 ...
 */
        #define CENTRAL_ATT_RX_MTU      256                                     //user set value
        #define PERIPHR_ATT_RX_MTU      256                                     //user set value
...
extern u8 app_cen_l2cap_tx_buf[];                                               //ACL Central L2cap RX data buffer
