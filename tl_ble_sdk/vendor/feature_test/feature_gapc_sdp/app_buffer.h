...
#include "app_config.h"
    ...
    /*
 * if ACL TX & RX octets and MTU size both use minimum value,
 * different feature project can share default_buffer.h/default_buffer.c
 */
    #if (!APP_DEFAULT_BUFFER_ACL_OCTETS_MTU_SIZE_MINIMUM)
 ...
 */
        #define ACL_CONN_MAX_RX_OCTETS 144 //user set value
 ...
 */
        #define ACL_CENTRAL_MAX_TX_OCTETS 144 //user set value
        #define ACL_PERIPHR_MAX_TX_OCTETS 144 //user set value
 ...
 */
        #define CENTRAL_ATT_RX_MTU      144                                     //user set value
        #define PERIPHR_ATT_RX_MTU      144                                     //user set value
...
extern u8 app_cen_l2cap_tx_buf[];                                               //ACL Central L2cap TX data buffer
