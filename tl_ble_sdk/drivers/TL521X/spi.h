...
typedef enum
{
    GSPI_MODULE = 1, /* Note:  TL521X supports two spi: GSPI and GSPI1. */
    GSPI1_MODULE = 2,
} spi_sel_e;
...
#define gspi1_reset()                                                                                 spi_hw_fsm_reset(GSPI1_MODULE)
...
/**
 * @brief      This function selects  pin  for gspi1 master or slave mode.
 * @param[in]  pin       - the selected pin.
 * @param[in]  function  - pin-multiplexing function.
 * @return     none.
 */
void gspi1_set_pin_mux(gpio_func_pin_e pin, gpio_func_e function);
 ...
 * @param[in]   gspi1_pin_config - the pointer of pin config struct.
 * @return      none.
 */
