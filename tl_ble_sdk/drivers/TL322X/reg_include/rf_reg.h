...
#define reg_rf_txrx_dbg2_0 REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x42)

enum
{
    FLD_RF_CHNL_POW_CH_PDET_RST_EN   = BIT(0),
    FLD_RF_CHNL_POW_CH_PDET_RST_VAL  = BIT(1),
    FLD_RF_RX_AMP_SETL_TIME          = BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_LNA_ITRIM       = BIT_RNG(0, 1),
    FLD_RF_MIX_VBIAS       = BIT_RNG(2, 3),
    FLD_RF_PA_VBIAS        = BIT_RNG(4, 5),
    FLD_RF_RTFE_PTAT_FORCE = BIT(6),
    FLD_RF_FE_RTRIM_TX_L   = BIT(7),
};

#define reg_rf_cbpf_adc_0      REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x14e)
enum
{
    FLD_RF_CBPF_TRIM_I            = BIT_RNG(0, 1),
    FLD_RF_CBPF_TRIM_Q            = BIT_RNG(2, 3),
    FLD_RF_CBPF_EN_DIAG_MEAS      = BIT(4),
    FLD_RF_CBPF_TRIM_SHORT_DCBIAS = BIT_RNG(5, 6),
    FLD_RF_CBPF_VCM_TRIM_L        = BIT(7),
};


#define reg_rf_cbpf_adc_1      REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x14f)
enum
{
    FLD_RF_CBPF_VCM_TRIM_H   = BIT(0),
    FLD_RF_ADC_TRIM          = BIT_RNG(1, 2),
    FLD_RF_ADC_INVERT_CLK    = BIT(3),
};
...
enum
{
    ...
    FLD_RF_VCO_EN_PKDET       = BIT(3),
    FLD_RF_LDOTRIM_TRIM_VREF  = BIT_RNG(4, 5),
};

#define reg_rf_reg_sparelv1       REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x15c)

enum
{
    FLD_RF_FCAL_DIS_STATIC_3K   = BIT(0),
    FLD_RF_CBPF_HIZ_DIS_I       = BIT(1),
    FLD_RF_CBPF_HIZ_DIS_Q       = BIT(2),
    FLD_RF_SPARE_STATIC         = BIT(3),
    FLD_RF_CBPF_HIGH_GBW        = BIT(4),
};
...
#define reg_rf_lpm_hpm_dly0               REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x1d6)

enum
{
    FLD_RF_TXC_HPM_DLY_EN  = BIT(0),
    FLD_RF_TXC_HPM_DLY     = BIT_RNG(1, 3),
    FLD_RF_TXC_LPM_DLY_EN  = BIT(4),
    FLD_RF_TXC_LPM_DLY     = BIT_RNG(5, 6),
};
