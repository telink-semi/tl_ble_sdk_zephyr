 ...
 *                        Currently, PLL_CLK_192M is used by default in the driver. Setting other frequencies is invalid.
 *                        (Because the pll clock source has a large range of influence and is relatively dispersed,
 *                        192M can also meet the existing demand, so frequency switching is not considered for the time being.)
 * @return      none.
