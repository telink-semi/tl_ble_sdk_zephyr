 ...
 * @param[in]   msg_bytes       - word length of msg.
 * @return      none
 * @note
  @verbatim
 ...
 */
    ...
    void hash_dma_operate(unsigned int in_h, unsigned int in_l, unsigned int out_h, unsigned int out_l, unsigned int inByteLen, HASH_CALLBACK callback);
    #else
